...
function aturKonten($konten) {
	$max = 200;
	if (strlen($konten) > $max) {
		return substr($konten, 0, $max) . "...";
	} else {
		return $konten;
	}
}
          ...
          <ul class="art-list-body">
			<?php
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					echo	'<h2 class="art-list-title"><a href="post.php?id='; echo $row["id"]; echo '">'; echo $row["judul"]; echo'</a></h2>';
					echo	'<div class="art-list-time">'; echo convertDate($row["tanggal"]); echo'</div>';
