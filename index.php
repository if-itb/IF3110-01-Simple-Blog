		 ...
		 <?php while($row = mysqli_fetch_array($result)) {?>
            ...
            <li class="art-list-item">
                <div class="art-list-item-title-and-time">
                    <h2 class="art-list-title"><a href="post.php?PostID=<?php echo $row['PostID']; ?>"><?php echo $row['Judul']; ?></a></h2>
                    <div class="art-list-time"><?php echo $row['Tanggal']; ?></div>
                    <div class="art-list-time"><span style="color:#F40034;">&#10029;</span> Featured</div>
                </div>
                <p><?php echo $row['Konten']; ?></p>
                <p>
                  <a href="edit_post.php?PostID=<?php echo $row['PostID']; ?>">Edit</a> | <a href="#">Hapus</a>
                </p>
            </li>
		<?php }
mysqli_close($con);?>		
