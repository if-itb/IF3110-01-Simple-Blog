            ...
            <?php
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                echo "      
                      ...
                      <p>".$row['KONTEN']."</p>
                      <p>
                        <a href=\"edit_post.php?id=".$row['ID']."\">Edit</a> | <a href=\"delete.php?id=".$row['ID']."\" onclick=\"return window.confirm('Apakah Anda yakin menghapus post ini?')\">Hapus</a> | <a href=\"setFeatured.php?id=".$row['ID']."&fea=".$row['FEATURED']."\")\">Mark as Featured</a>
                      </p>
                  </li>
                    ";
              }
