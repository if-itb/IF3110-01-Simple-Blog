...
<body class="default">
        ...
        <article class="art simple post">
            ...
            <div class="art-body">
                <div class="art-body-inner">
                    ...
                    <div id="contact-area">
                        <form id="post" name="post" method="post" action="new_post.php">
                            ...
                            <input type="submit" name="simpan" value="simpan" class="submit-button" onclick="validate_tanggal()">
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        function validate_tanggal() {
            var date_input = $('#Tanggal').value;
            var date_now = new Date();
            console.log("date input : " + date_input);
            console.log(" date now : " + date_now);
            var onlynow = date_now.setHours(0,0,0,0);
            //var onlyinput = date_input.setHours(0,0,0,0);
            console.log("date only : " + onlynow);
            console.log("input only date: " + date_input);
            
            $('#post').submit(function(ev){
                if (onlynow > date_input) {
                    ev.preventDefault(); 
