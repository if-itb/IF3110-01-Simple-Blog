...
<script type=text/javascript>
	function validateDate(){
		var datecheck=document.getElementsByName('Tanggal')[0].value;
        ...
        <div class="art-body-inner">
            ...
            <div id="contact-area">
                <form method="post" action="#">
                    ...
                    <input type="submit" name="submit" value="Simpan" onclick="return validateDate()" class="submit-button">
                </form>
            </div>
        </div>
    </div>
