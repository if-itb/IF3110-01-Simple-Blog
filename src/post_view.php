...
echo '<a href="post_edit.php?id='.$_GET['id'].'">Edit</a> | ';
echo "<a onclick='return confirm(\"Apakah Anda yakin menghapus post ini?\")'href=post_delete.php?id={$_GET['id']}>Delete </a> | ";
