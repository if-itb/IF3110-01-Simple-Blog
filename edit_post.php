...
<article class="art simple post">
    ...
    <div class="art-body">
        <div class="art-body-inner">
            ...
            <div id="contact-area">
                <form autocomplete="off" method="post" onsubmit="return validDate();" action="do_edit_post.php">
                    <label for="Judul">Judul:</label>
                    <input type="text" value="<?php echo($post['judul']); ?>" name="Judul" id="Judul" required>

                    <label for="Tanggal">Tanggal:</label>
                    <input type="text" name="Tanggal" id="Tanggal" value="<?php echo date("Y-m-d"); ?>" placeholder="yyyy-mm-dd" required>
                    
                    <label for="Konten">Konten:</label><br>
                    <textarea name="Konten" rows="30" cols="30" id="Konten" required> <?php echo($post['konten']); ?> </textarea>
