...
<title>Stephen Blog | Edit Post</title>
...
<?php
    ...
    <div class=\"art-body\">
        <div class=\"art-body-inner\">
            ...
            <div id=\"contact-area\">
                <form method=\"post\" action=\"edit_post2.php?id=".$ID."\" onSubmit=\"return cekTanggal()\">
                    <label for=\"Judul\">Judul:</label>
                    <input type=\"text\" name=\"Judul\" id=\"Judul\" value=\"".$row['JUDUL']."\">

                    <label for=\"Tanggal\">Tanggal:</label>
                    <input type=\"text\" name=\"Tanggal\" id=\"Tanggal\" value=".$row['TANGGAL']." placeholder=\"cth : 1994-11-29\">
