...
<?php
	...
	function conv_to_display($str)
	{
		$splitted = explode("-",$str);
		$result = $splitted[2]." ".$splitted[1]." ".$splitted[0];
		return $result;
	}
?>
<meta charset="utf-8">
...
<article class="art simple post">
	...
	<div class="art-body">
        <div class="art-body-inner">
            ...
            <div id="contact-area">
                <form method="post" name="buat_post" action=<?php echo "post_editor.php?id=".$_GET['id']?> onsubmit="return is_date_valid()">
                    <label for="Judul">Judul:</label>
                    <input type="text" name="Judul" id="Judul" value=<?php echo "\"".$row['Title']."\"" ?>>

                    <label for="Tanggal">Tanggal:</label>
                    <input type="text" name="Tanggal" id="Tanggal" value=<?php echo "\"".conv_to_display($row['Date'])."\"" ?>>
