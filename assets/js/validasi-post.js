...
function validateDateNow(inputDate) {
	...
	if (datePost < dateNow) {
		...
		document.tambah_post.Tanggal.focus();
		return false;
	} else {
		return true;
	}
...
function validateDate(inputDate) {
	...
	if (validateDateFormat(inputDate) == true) {
		if (validateDateConstraints(inputDate) == false) {
			...
			return validateDateNow(inputDate);			
		}
	} else {
...
function validatePost() {	
	...
	if (judulPost == "") {
		...
		document.tambah_post.Judul.focus();
		return false;
	}
	...
	if (kontenPost == "") {
		...
		document.tambah_post.Konten.focus();
		return false;
	}
	
	var inputDate = document.getElementById("Tanggal").value;
	return validateDate(inputDate);
}