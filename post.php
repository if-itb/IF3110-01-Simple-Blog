	...
	?> 
            ...
            <div id="contact-area">
                <form method="post">
                    ...
                    <input type="submit" name="submit" value="Kirim" class="submit-button" onclick = "myFunction(<?php echo $_GET['IDPOST']?>); return false;">
                </form>
            </div>
            ...
            <ul class="art-list-body" id="comment-area">
			 <?php
				require ("sqlconnect.php");
				$query = "SELECT * FROM listcomment ORDER BY IDcomment DESC";
				$result = mysqli_query($con,$query);
				while($row = mysqli_fetch_array($result))
				{
				echo
...
function loadXMLDoc(url,cfunc)
		...
		if (!validateEmail(email)) {
			alert('Email yang Anda masukkan ngaco jing');
			document.getElementById("Email").focus();
			return false;
		}
		var komentar = document.getElementById("Komentar").value;
		var url = "IDPOST="+ idpost +"&Nama=" + nama + "&Email=" + email + "&Komentar=" + komentar;
		loadXMLDoc("commenting.php?"+url,function()
		  {
