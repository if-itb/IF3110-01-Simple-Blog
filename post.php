...
<title>Simple Blog | </title><title>Apa itu Simple Blog?</title>
...
<article class="art simple post">
    ...
    <div class="art-body">
        <div class="art-body-inner">
            <?php
            $stmt = $db->prepare('select Pid, judul, konten, tanggal from post where Pid=:Pid');
            ...
            echo '<div>';
                ...
                echo '<p>'.date('jS M Y', strtotime($row['tanggal'])).'</p>';
                echo '<p>'.$row['konten'].'</p>'
            echo '</div>';
            ?>
