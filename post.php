<?php
    ...
    $id = $_GET['id'];
try {
        //mendapatkan isi tabel posts dari database
...
<article class="art simple post">
    ...
    <header class="art-header">
        <div class="art-header-inner" style="margin-top: 0px; opacity: 1;">
            <time class="art-time"><?php echo date('j M Y', strtotime($row['Tanggal']));?></time>
    ...
    <div class="art-body">
        <div class="art-body-inner">
            ...
            <div id="contact-area">
                <form method="post" action="javascript:sendRequest(<?php echo $id ?>)">
            ...
            <ul class="art-list-body" id="listcomment">
                <?php
                    try{
