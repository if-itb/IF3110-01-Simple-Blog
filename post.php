...
<?php 
    ...
    $id = $_GET['id'];
    $query = "SELECT judul, tanggal, isi FROM blog WHERE id=$id";
...
<body class="default" onload="load_comment(<?php echo $id ?>)">
<div class="wrapper">
<nav class="nav">
...
<article class="art simple post">
    ...
    <div class="art-body-post">
        <div class="art-body-inner">
            ...
            <div id="contact-area">
                <form method="post" name="comment" onsubmit="return false">
                    ...
                    <input type="hidden" name="id_post" id="id-post" value="<?php echo $id; ?>">
                    <input type="submit" name="submit" value="Kirim" class="submit-button" onclick="add_comment()">
                </form>
            </div>
