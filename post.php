<?php
    ...
    if (isset($_GET['id'])){
        $view=$_GET['id'];
        $strSql= mysqli_query($con,"select * from blogtable where no_post=$view");
...
<article class="art simple post">
    ...
    <div class="art-body">
        <div class="art-body-inner">
            ...
            <div id="contact-area">
                <form method="post" id="comment-form" onsubmit="return false;">
                    ...
                    <input type="submit" name="submit" value="Kirim" class="submit-button" onclick="addComment(<?php echo $_GET['id'] ?>)">
                </form>
            </div>
...
<script type="text/javascript">
    ...
    function addComment(id){
        ...
        if (validateEmail(email)){
            ...
            xmlhttp.open("GET","AddComment.php?id="+id+"&Nama="+nama+"&Email="+email+"&Komentar="+komentar,true);
            xmlhttp.send();
        }
        else {
    ...
    function showComment(id){
        ...
        xmlhttp.open("GET","ShowComment.php?id="+id,true);
        xmlhttp.send();
    }
